                ...
                <tr class="dark:bg-gray-900 dark:border-gray-700 bg-green-700 text-white">
                    ...
                    <td class="px-2 py-2 flex items-center gap-2">
                        ...
                        <div class="relative group inline-block">
                            <a href="{{ $userType === 'IREAP' 
                                        ? route('ireap.view-subproject', $subproject->id) 
                                        : '#' }}"
                        ...
                        <!-- Edit Button -->
                        <div class="relative group inline-block">
                            <a href="{{ $userType === 'IREAP' && $subproject->iReapStatus 
                                            ? route('ireap.edit-subproject', $subproject->id) 
                                            : ($userType === 'IREAP' 
                                                ? route('ireap.validate-subprojects', $subproject->id) 
                                                : '#') }}"
