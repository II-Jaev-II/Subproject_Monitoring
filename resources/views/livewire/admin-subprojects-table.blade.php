<div>
    <section>
        <div>
            <!-- Start coding here -->
            <div class="">
                <div class="flex items-center justify-between d space-x-4 p-4">
                    <div class="flex">
                    ...
                    <div class="flex space-x-3">
                        <div class="flex space-x-3 items-center">
                            <label class="w-40 text-sm font-medium text-gray-900 dark:text-white">Proponent:</label>
                            <select wire:model.live="proponent"
                                ...
                                <option value="CLGU">CLGU</option>
                                <option value="MLGU">MLGU</option>
                                <option value="PLGU">PLGU</option>
                            </select>
                            <label class="w-40 text-sm font-medium text-gray-900 dark:text-white">Project Type:</label>
                            ...
                            <label class="w-40 text-sm font-medium text-gray-900 dark:text-white">Project
                                Category:</label>
                            <select wire:model.live="projectCategory"
                                class="bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                                <option value="All">All</option>
                            ...
                            <label class="w-40 text-sm font-medium text-gray-900 dark:text-white">Clearances:</label>
                            ...
                            <label class="w-40 text-sm font-medium text-gray-900 dark:text-white">Inactive Days:</label>
                        ...
                        <tbody>
                            @foreach ($subprojects as $subproject)
                                <tr class="dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 dark:text-white">{{ $subproject->projectType }}</td>
                                    <td class="px-4 py-3 dark:text-white">{{ $subproject->projectCategory }}</td>
                                    ...
                                    <td class="px-4 py-3 flex items-center gap-3">
                                        <div class="relative group inline-block">
                                            <a href="#"
                                                ...
                                                <img src="/images/eye.svg" alt="View" width="15"
                                                    height="15">
                                            </a>
                                            <span
