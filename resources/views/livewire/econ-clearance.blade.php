                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 dark:text-white">{{ $econRecord->econ === 'OK' ? 'Cleared' : 'Not Cleared' }}</td>
                                <td class="px-4 py-3 flex items-center gap-3">
                                    <div class="relative group inline-block">
                                        <a href="{{ 
                                                $userType === 'IBUILD' ? route('ibuild.view-subproject', $econRecord->id) : 
                                                ($userType === 'IPLAN' ? route('iplan.view-subproject', $econRecord->id) : 
                                                ($userType === 'ECON' ? route('econ.view-subproject', $econRecord->id) : 
                                                ($userType === 'SES' ? route('ses.view-subproject', $econRecord->id) : 
