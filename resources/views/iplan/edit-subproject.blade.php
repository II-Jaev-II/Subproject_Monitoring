                    ...
                    <form action="{{ route('iplan.update-subproject', $subproject->id) }}" method="POST"
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <select name="sensitivity" id="sensitivity" class="block border-1 rounded-md border-gray-700 bg-gray-900 w-full mt-1">
                                    <option {{ old('sensitivity') ? '' : 'selected' }}>{{ $checklist->sensitivity }}</option>
                                    <option value="-0.50 - -1.00 - Gain" {{ old('sensitivity') == '-0.50 - -1.00 - Gain' ? 'selected' : '' }}>-0.50 - -1.00 - Gain</option>
                                    <option value="-0.25 - -0.50 - Gain" {{ old('sensitivity') == '-0.25 - -0.50 - Gain' ? 'selected' : '' }}>-0.25 - -0.50 - Gain</option>
                                    <option value="-0.05 - -0.25 - Gain" {{ old('sensitivity') == '-0.05 - -0.25 - Gain' ? 'selected' : '' }}>-0.05 - -0.25 - Gain</option>
                                    <option value="0 - No Change" {{ old('sensitivity') == '0 - No Change' ? 'selected' : '' }}>0 - No Change</option>
                                    <option value="0.05 - 0.25 - Loss" {{ old('sensitivity') == '0.05 - 0.25 - Loss' ? 'selected' : '' }}>0.05 - 0.25 - Loss</option>
                                    <option value="0.25 - 0.50 - Loss" {{ old('sensitivity') == '0.25 - 0.50 - Loss' ? 'selected' : '' }}>0.25 - 0.50 - Loss</option>
                                    <option value="0.50 - 1.00 - Loss" {{ old('sensitivity') == '0.50 - 1.00 - Loss' ? 'selected' : '' }}>0.50 - 1.00 - Loss</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select name="exposure" id="exposure" class="block border-1 rounded-md border-gray-700 bg-gray-900 w-full mt-1">
                                    <option {{ old('exposure') ? '' : 'selected' }}>{{ $checklist->exposure }}</option>
                                    <option value="0.00 - 0.20 Very Low" {{ old('exposure') == '0.00 - 0.20 Very Low' ? 'selected' : '' }}>0.00 - 0.20 Very Low</option>
                                    <option value="0.20 - 0.40 Low" {{ old('exposure') == '0.20 - 0.40 Low' ? 'selected' : '' }}>0.20 - 0.40 Low</option>
                                    <option value="0.40 - 0.60 Moderate" {{ old('exposure') == '0.40 - 0.60 Moderate' ? 'selected' : '' }}>0.40 - 0.60 Moderate</option>
                                    <option value="0.60 - 0.80 High" {{ old('exposure') == '0.60 - 0.80 High' ? 'selected' : '' }}>0.60 - 0.80 High</option>
                                    <option value="0.80 - 1.00 Very High" {{ old('exposure') == '0.80 - 1.00 Very High' ? 'selected' : '' }}>0.80 - 1.00 Very High</option>
                                </select>
                            ...
                            <div>
                                <label for="adaptiveCapacity" class="dark:text-green-600">Adaptive Capacity <span class="dark:text-red-500">*</span></label>
                                <select name="adaptiveCapacity" id="adaptiveCapacity" class="block border-1 rounded-md border-gray-700 bg-gray-900 w-full mt-1">
                                    <option {{ old('adaptiveCapacity') ? '' : 'selected' }}>{{ $checklist->adaptiveCapacity }}</option>
                                    <option value="0.00 - 0.20 Very Low" {{ old('adaptiveCapacity') == '0.00 - 0.20 Very Low' ? 'selected' : '' }}>0.00 - 0.20 Very Low</option>
                                    <option value="0.20 - 0.40 Low" {{ old('adaptiveCapacity') == '0.20 - 0.40 Low' ? 'selected' : '' }}>0.20 - 0.40 Low</option>
                                    <option value="0.40 - 0.60 Moderate" {{ old('adaptiveCapacity') == '0.40 - 0.60 Moderate' ? 'selected' : '' }}>0.40 - 0.60 Moderate</option>
                                    <option value="0.60 - 0.80 High" {{ old('adaptiveCapacity') == '0.60 - 0.80 High' ? 'selected' : '' }}>0.60 - 0.80 High</option>
                                    <option value="0.80 - 1.00 Very High" {{ old('adaptiveCapacity') == '0.80 - 1.00 Very High' ? 'selected' : '' }}>0.80 - 1.00 Very High</option>
                                </select>
                            ...
                            <div>
                                <label for="overallVulnerability" class="dark:text-green-600">Overall Vulnerability <span class="dark:text-red-500">*</span></label>
                                <select name="overallVulnerability" id="overallVulnerability" class="block border-1 rounded-md border-gray-700 bg-gray-900 w-full mt-1">
                                    <option {{ old('overallVulnerability') ? '' : 'selected' }}>{{ $checklist->overallVulnerability }}</option>
                                    <option value="0.00 - 0.20 Very Low" {{ old('overallVulnerability') == '0.00 - 0.20 Very Low' ? 'selected' : '' }}>0.00 - 0.20 Very Low</option>
                                    <option value="0.20 - 0.40 Low" {{ old('overallVulnerability') == '0.20 - 0.40 Low' ? 'selected' : '' }}>0.20 - 0.40 Low</option>
                                    <option value="0.40 - 0.60 Moderate" {{ old('overallVulnerability') == '0.40 - 0.60 Moderate' ? 'selected' : '' }}>0.40 - 0.60 Moderate</option>
                                    <option value="0.60 - 0.80 High" {{ old('overallVulnerability') == '0.60 - 0.80 High' ? 'selected' : '' }}>0.60 - 0.80 High</option>
                                    <option value="0.80 - 1.00 Very High" {{ old('overallVulnerability') == '0.80 - 1.00 Very High' ? 'selected' : '' }}>0.80 - 1.00 Very High</option>
                                </select>
                            ...
                            <div>
                                ...
                                <textarea name="recommendation" id="recommendation" rows="4"
                                    class="block border-1 rounded-md border-gray-700 bg-gray-900 w-full mt-1">{{ old('recommendation',$checklist->recommendation) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="generalRecommendation" id="generalRecommendation" rows="4"
                                    class="block border-1 rounded-md border-gray-700 bg-gray-900 w-full mt-1">{{ old('generalRecommendation', $checklist->generalRecommendation) }}</textarea>
