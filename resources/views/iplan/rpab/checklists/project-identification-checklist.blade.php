...
<div x-data="{ selectedOptionEvsa: '' }" x-cloak>
    ...
    <div x-cloak style="display: none !important;" x-show="selectedOptionEvsa" x-transition class="mt-3"
        x-effect="if (!selectedOptionEvsa) { $refs.evsaTextbox.value = '' }">
        ...
        <textarea x-ref="evsaTextbox" class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1 p-2"
            rows="2" name="evsa" id="evsa"></textarea>
    </div>
</div>

<div x-data="{ selectedOptionProductionArea: '' }" x-cloak>
    <div class="flex items-center space-x-3">
    ...
    <div x-cloak style="display: none !important;" x-show="selectedOptionProductionArea" x-transition class="mt-3"
        x-effect="if (!selectedOptionProductionArea) { $refs.productionAreaTextbox.value = '' }">
        <label class="block text-sm font-medium"
        ...
        <textarea x-ref="productionAreaTextbox" class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1 p-2"
...
<div x-data="{ selectedOptionDiscussConstraint: '' }" x-cloak>
    <div class="flex items-center space-x-3">
    ...
    <div x-cloak style="display: none !important;" x-show="selectedOptionDiscussConstraint" x-transition class="mt-3"
        x-effect="if (!selectedOptionDiscussConstraint) { $refs.discussConstraintTextbox.value = '' }">
        <label class="block text-sm font-medium"
        ...
        <textarea x-ref="discussConstraintTextbox" class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1 p-2"
...
<div x-data="{ selectedOptionAvailableProductForm: '' }" x-cloak>
    <div class="flex items-center space-x-3">
    ...
    <div x-cloak style="display: none !important;" x-show="selectedOptionAvailableProductForm" x-transition class="mt-3"
        x-effect="if (!selectedOptionAvailableProductForm) { $refs.availableProductFormTextbox.value = '' }">
        <label class="block text-sm font-medium"
        ...
        <textarea x-ref="availableProductFormTextbox" class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1 p-2"
            rows="2" name="availableProductForm" id="availableProductForm"></textarea>
    </div>
</div>

<div x-data="{ selectedOptionDiscussIntervention: '' }" x-cloak>
    <div class="flex items-center space-x-3">
    ...
    <div x-cloak style="display: none !important;" x-show="selectedOptionDiscussIntervention" x-transition class="mt-3"
        x-effect="if (!selectedOptionDiscussIntervention) { $refs.discussInterventionTextbox.value = '' }">
        <label class="block text-sm font-medium"
        ...
        <textarea x-ref="discussInterventionTextbox" class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1 p-2"
...
<div x-data="{ selectedOptionValueAddingMechanism: '' }" x-cloak>
    <div class="flex items-center space-x-3">
    ...
    <div x-cloak style="display: none !important;" x-show="selectedOptionValueAddingMechanism" x-transition class="mt-3"
        x-effect="if (!selectedOptionValueAddingMechanism) { $refs.valueAddingMechanismTextbox.value = '' }">
        <label class="block text-sm font-medium"
        ...
        <textarea x-ref="valueAddingMechanismTextbox" class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1 p-2"
            rows="2" name="valueAddingMechanism" id="valueAddingMechanism"></textarea>
    </div>
</div>

<div x-data="{ selectedOptionIncreaseValue: '' }" x-cloak>
    <div class="flex items-center space-x-3">
    ...
    <div x-cloak style="display: none !important;" x-show="selectedOptionIncreaseValue" x-transition class="mt-3"
        x-effect="if (!selectedOptionIncreaseValue) { $refs.increaseValueTextbox.value = '' }">
        <label class="block text-sm font-medium"
        ...
        <textarea x-ref="increaseValueTextbox" class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1 p-2"
