<div x-data="{ selectedOptionTotalPopulation: '' }" x-cloak>
    ...
    <div x-cloak style="display: none !important;" x-show="selectedOptionTotalPopulation" x-transition class="mt-3"
        x-effect="if (!selectedOptionTotalPopulation) { $refs.totalPopulationTextbox.value = '' }">
        ...
        <textarea x-ref="totalPopulationTextbox" class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1 p-2"
            rows="2" name="totalPopulation" id="totalPopulation"></textarea>
    </div>
</div>

<div x-data="{ selectedOptionAverageHouseholdSize: '' }" x-cloak>
    <div class="flex items-center space-x-3">
    ...
    <div x-cloak style="display: none !important;" x-show="selectedOptionAverageHouseholdSize" x-transition class="mt-3"
        x-effect="if (!selectedOptionAverageHouseholdSize) { $refs.averageHouseholdSizeTextbox.value = '' }">
        <label class="block text-sm font-medium"
        ...
        <textarea x-ref="averageHouseholdSizeTextbox" class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1 p-2"
            rows="2" name="averageHouseholdSize" id="averageHouseholdSize"></textarea>
    </div>
</div>

<div x-data="{ selectedOptionEducationPopulation: '' }" x-cloak>
    <div class="flex items-center space-x-3">
    ...
    <div x-cloak style="display: none !important;" x-show="selectedOptionEducationPopulation" x-transition class="mt-3"
        x-effect="if (!selectedOptionEducationPopulation) { $refs.educationPopulationTextbox.value = '' }">
        <label class="block text-sm font-medium"
        ...
        <textarea x-ref="educationPopulationTextbox" class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1 p-2"
            rows="2" name="educationPopulation" id="educationPopulation"></textarea>
    </div>
</div>

<div x-data="{ selectedOptionPopulation: '' }" x-cloak>
    <div class="flex items-center space-x-3">
    ...
    <div x-cloak style="display: none !important;" x-show="selectedOptionPopulation" x-transition class="mt-3"
        x-effect="if (!selectedOptionPopulation) { $refs.populationTextbox.value = '' }">
        <label class="block text-sm font-medium"
        ...
        <textarea x-ref="populationTextbox" class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1 p-2"
