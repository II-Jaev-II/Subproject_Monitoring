<div class="grid grid-cols-2 gap-2 mt-2">
    <div>
        ...
        <input class="block border-1 rounded-md border-gray-700 bg-gray-900 w-full mt-1" type="text" value="{{ old('valueChainSegment') }}" x-ref="valueChainSegment" name="valueChainSegment" id="valueChainSegment"
    ...
    <div>
        ...
        <input class="block border-1 rounded-md border-gray-700 bg-gray-900 w-full mt-1" type="text" value="{{ old('opportunity') }}" x-ref="opportunity" name="opportunity" id="opportunity"
            :required="linkedVca.includes('Yes')">
    </div>
    <div>
        <label for="specificIntervention" class="dark:text-green-600">Specific Intervention</label>
        <input class="block border-1 rounded-md border-gray-700 bg-gray-900 w-full mt-1" type="text" value="{{ old('specificIntervention') }}" x-ref="specificIntervention" name="specificIntervention" id="specificIntervention"
            :required="linkedVca.includes('Yes')">
    </div>
    <div>
