            ...
            <div class="bg-white border border-gray-300 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('ireap.store-subproject') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <label for="registeredAgencyLabel"
                            class="dark:text-green-600 text-black text-sm md:text-base">Registered with CDA/SEC/DOLE for
                            at least one (1) year</label>
                        <div class="flex items-center gap-2">
                            <div class="flex items-center gap-2">
                                <input class="dark:bg-gray-800" type="radio" name="registeredAgency"
                                    id="registeredAgency" value="Yes"
                                    {{ old('registeredAgency') === 'Yes' ? 'checked' : '' }}>
                                <label for="registeredAgencyYes">Yes</label>
                            </div>
                            <div class="flex items-center gap-2">
                                <input class="dark:bg-gray-800" type="radio" name="registeredAgency"
                                    id="registeredAgency" value="No"
                        ...
                        <div class="mt-4 mb-4">
                            <label for="certificates" class="dark:text-green-600 text-sm md:text-base">Certificate of
                        ...
                        <div class="mt-2 flex items-center justify-between">
                            <div class="grid grid-cols-2 w-80">
                                <label for="status" class="dark:text-green-600 text-sm md:text-base">Validation Status
                                    <span class="dark:text-red-500">*</span></label>
                                <select name="status" id="status"
                                    class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full py-1 px-2">
