        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white border border-gray-300 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('ggu.update-subproject', $subproject->id) }}" method="POST"
                        ...
                        <div class="mb-4">
                            <h1 for="iplanChecklist" class="dark:text-lime-500 text-sm md:text-lg">Edit GGU Checklist
                            </h1>
                            <hr class="border-2 border-green-600 dark:border-lime-500 mb-2">
                        </div>

                        <div class="flex items-center space-x-4 mb-6">
                            <label for="reviewDate" class="dark:text-lime-500 text-sm md:text-base">Date of Review <span
                        ...
                        <div class="grid grid-cols-1 md:flex items-center md:space-x-6">
                            ...
                            <div x-data="{ showFileInput: false }" class="">
                                <label for="kmzFileInput" class="dark:text-green-600 text-sm md:text-base">KMZ
                                    File</label>
                            ...
                            <!-- Report Section -->
                            <div x-data="{ showFileInput: false }" class="">
                                <label for="gguReportInput"
                                    class="dark:text-green-600 text-sm md:text-base">Report</label>
                                <div class="flex items-center mt-1 rounded-md overflow-hidden">
                                    <button type="button" @click="showFileInput = !showFileInput"
                                        class="flex items-center justify-center px-3 py-2 bg-blue-400 dark:bg-sky-500 text-gray-700 dark:text-white text-sm font-medium hover:bg-blue-500 dark:hover:bg-sky-600 transition ease-in-out duration-150 h-full">
                                        <img src="/images/pencil-square.svg" alt="Edit" width="22"
                                    ...
                                    <input id="gguReportInput" type="file" name="gguReport" x-show="showFileInput"
                                        class="px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded-md w-full"
                                        style="display: none;">

                                    <a x-show="!showFileInput"
                                        class="flex items-center gap-2 border-l px-3 py-2 text-sm font-medium rounded-r-md text-white dark:text-white bg-green-500 dark:bg-lime-500 hover:text-gray-700 dark:hover:text-gray-300 transition ease-in-out duration-150 h-full"
                                        href="{{ asset($gguChecklist->gguReport) }}" target="_blank">
                                        <img src="/images/file-earmark-text.svg" alt="Save" width="22"
                                            height="22">
                                        View File
                                    </a>
