                        ...
                        <div class="flex items-center space-x-6">
                            ...
                            <div class="">
                                ...
                                <div class="flex items-center mt-1 rounded-md overflow-hidden">
                                    <label for="kmzFileInput" class="flex items-center justify-center px-3 py-2 cursor-pointer bg-gray-300 dark:bg-sky-500 text-gray-700 dark:text-white text-sm font-medium hover:bg-gray-400 dark:hover:bg-sky-600 transition ease-in-out duration-150 h-full">
                                        <img src="/images/pencil-square.svg" alt="Edit" width="22" height="22">
                                    </label>
                                    <input id="kmzFileInput" type="file" name="kmzFile" class="hidden">
                                    <a class="flex items-center gap-2 border-l px-3 py-2 text-sm font-medium rounded-r-md text-white dark:text-white bg-gray-400 dark:bg-lime-500 hover:text-gray-200 dark:hover:text-gray-300 transition ease-in-out duration-150 h-full"
                                        href="{{ asset($gguChecklist->kmzFile) }}" target="_blank">
                            ...
                            <div class="">
                                ...
                                <div class="flex items-center mt-1 rounded-md overflow-hidden">
                                    <label for="gguReportInput" class="flex items-center justify-center px-3 py-2 cursor-pointer bg-gray-300 dark:bg-sky-500 text-gray-700 dark:text-white text-sm font-medium hover:bg-gray-400 dark:hover:bg-sky-600 transition ease-in-out duration-150 h-full">
                                        <img src="/images/pencil-square.svg" alt="Edit" width="22" height="22">
                                    </label>
                                    <input id="gguReportInput" type="file" name="gguReport" class="hidden">
                                    <a class="flex items-center gap-2 border-l px-3 py-2 text-sm font-medium rounded-r-md text-white dark:text-white bg-gray-400 dark:bg-lime-500 hover:text-gray-200 dark:hover:text-gray-300 transition ease-in-out duration-150 h-full"
                                        href="{{ asset($gguChecklist->report) }}" target="_blank">
                                        <img src="/images/file-earmark-text.svg" alt="Save" width="22" height="22">
                                        View File
                                    </a>
                                </div>
