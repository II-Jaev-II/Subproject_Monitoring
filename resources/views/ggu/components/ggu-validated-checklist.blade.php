...
<label for="reviewDate" class="dark:text-lime-500 text-3xl">Report</label>
<div class="flex items-center justify-center min-h-screen mb-4 mt-2">
...
<div class="mb-2">
    <label for="remarks" class="dark:text-lime-500">Remarks</label>
    <textarea
