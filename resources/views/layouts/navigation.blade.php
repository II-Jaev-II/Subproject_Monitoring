<nav x-data="{ open: false }" class="bg-lime-600 dark:bg-green-900 border-b border-lime-500 dark:border-green-700">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-100 dark:text-white bg-gray-400 dark:bg-lime-500 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                ...
                <button id="theme-toggle" type="button"
                    class="text-gray-300 dark:text-yellow-300  focus:outline-none rounded-lg text-sm p-2.5">
