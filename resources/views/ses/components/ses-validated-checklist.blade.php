...
<div class="mb-6">
    <div class="flex items-start space-x-3">
        <label for="reason" class="dark:text-green-600 text-xs md:text-base leading-tight flex-1">
...
<div class="mb-6">
    <div class="flex items-start space-x-3">
        <label for="requirements" class="dark:text-green-600 text-xs md:text-base leading-tight flex-1">
...
<div class="mb-6">
    <div class="flex items-start space-x-3">
        <label for="requirementsTable" class="dark:text-green-600 text-xs md:text-base leading-tight flex-1">
...
<div class="mb-6">
    <div class="flex items-start space-x-3">
        <label for="cleared" class="dark:text-green-600 text-xs md:text-base leading-tight flex-1">
...
<div class="mb-6">
    <label for="socialAssesment" class="dark:text-green-600 text-xs md:text-base leading-tight flex-1">
        Social Assesment
    </label>
    <div class="mt-2 mb-2">
...
<div class="mb-6">
    <label for="environmentalAssesment" class="dark:text-green-600 text-xs md:text-base leading-tight flex-1">
