@if ($subprojectType === 'Bridge' || $subprojectType === 'FMR')
    ...
    <div class="flex items-center gap-2">
        <div class="flex items-center gap-2">
            <input class="dark:bg-gray-800" type="radio"
                {{ isset($fmrBridgeChecklists->connectedAllWeather) && $fmrBridgeChecklists->connectedAllWeather === 'Yes' ? 'checked' : '' }}
                disabled>
            <label for="connectedAllWeatherYes">Yes</label>
        </div>
        <div class="flex items-center gap-2">
            <input class="dark:bg-gray-800" type="radio"
                {{ isset($fmrBridgeChecklists->connectedAllWeather) && $fmrBridgeChecklists->connectedAllWeather === 'No' ? 'checked' : '' }}
                disabled>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3 mb-4">
        ...
        @if ($fmrBridgeChecklists->maximumFloodLevel)
            <div>
                <label for="maximumFloodLevel" class="dark:text-green-600 text-sm md:text-base">Maximum flood level for
                    the
                    past 20 years</label>
                <input
                    class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1"
        ...
        @if ($fmrBridgeChecklists->fmrBridgeAccreditedDistance)
            <div>
                <label for="fmrBridgeAccreditedDistance" class="dark:text-green-600 text-sm md:text-base">Distance from
                    accredited DPWH quarry
                    site</label>
        ...
        @else
            <div>
                <label for="fmrBridgeAccreditedDistance" class="dark:text-green-600 text-sm md:text-base">Distance from
                    accredited DPWN quarry site</label>
                <div
                    class="relative flex items-center gap-2 text-md rounded-md border font-bold bg-red-600 text-white dark:bg-red-800 border-red-400 px-2 py-2 mt-2 w-fit">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        class="bi bi-question-diamond-fill" viewBox="0 0 16 16">
...
@elseif ($subprojectType === 'VCRI')
    <div class="flex items-center space-x-4 mb-2">
        ...
        <input type="text" value="{{ $formattedReviewDateIBuildVcri }}"
            class="dark:bg-gray-900 rounded-md dark:[color-scheme:dark]" readonly>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3 mb-4">
        ...
        @if ($vcriChecklists->lotDescription)
            <div>
                <label for="lotDescription" class="dark:text-green-600 text-sm md:text-base">Lot
                    Description</label>
                <input
                    class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1"
        ...
        @if ($vcriChecklists->maximumFloodLevel)
            <div>
                <label for="maximumFloodLevel" class="dark:text-green-600 text-sm md:text-base">Maximum flood
                    level for the
                    past 20 years</label>
                <input
                    class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1"
        ...
        @else
            <div>
                <label for="maximumFloodLevel" class="dark:text-green-600 text-sm md:text-base">Maximum flood
                    level for the past 20 years</label>
                <div
                    class="relative flex items-center gap-2 text-md rounded-md border font-bold bg-red-600 text-white dark:bg-red-800 border-red-400 px-2 py-2 mt-2 w-fit">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        class="bi bi-question-diamond-fill" viewBox="0 0 16 16">
        ...
        @if ($vcriChecklists->vcriAccreditedDistance)
            <div>
                <label for="vcriAccreditedDistance" class="dark:text-green-600 text-sm md:text-base">Distance from
                    accredited DPWH quarry
                    site</label>
                <a class="flex items-center gap-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-green-500 dark:bg-lime-500 hover:text-gray-700 dark:hover:text-gray-300 transition ease-in-out duration-150 px-3 py-2 w-fit mt-1"
        ...
        @else
            <div>
                <label for="vcriAccreditedDistance" class="dark:text-green-600 text-sm md:text-base">Distance from
                    the accredited DPWH quarry site</label>
                <div
                    class="relative flex items-center gap-2 text-md rounded-md border font-bold bg-red-600 text-white dark:bg-red-800 border-red-400 px-2 py-2 mt-2 w-fit">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        class="bi bi-question-diamond-fill" viewBox="0 0 16 16">
...
@elseif ($subprojectType === 'PWS' || $subprojectType === 'CIS')
    <div class="flex items-center space-x-4 mb-2">
        <label for="reviewDate" class="dark:text-green-600 text-sm md:text-base">Date of Review</label>
        <input type="text" value="{{ $formattedReviewDateIBuildPwsCis }}"
            class="dark:bg-gray-900 rounded-md dark:[color-scheme:dark]" readonly>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3 mb-4">
        ...
        @if ($pwsCisChecklists->waterSourceElevation)
            <div>
                <label for="waterSourceElevation" class="dark:text-green-600 text-sm md:text-base">Water Source
                    Elevation</label>
                <input
                    class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1"
        ...
        @if ($pwsCisChecklists->serviceArea)
            <div>
                <label for="serviceArea" class="dark:text-green-600 text-sm md:text-base">Service Area Topographic
                    Data</label>
                <input
                    class="block border-1 rounded-md dark:border-gray-700 dark:bg-gray-900 bg-gray-50 border-gray-400 w-full mt-1"
        ...
        @if ($pwsCisChecklists->pwsCisAccreditedDistance)
            <div>
                <label for="pwsCisAccreditedDistance" class="dark:text-green-600 text-sm md:text-base">Distance
                    from accredited DPWH quarry
                    site</label>
                <a class="flex items-center gap-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-green-500 dark:bg-lime-500 hover:text-gray-700 dark:hover:text-gray-300 transition ease-in-out duration-150 px-3 py-2 w-fit mt-1"
