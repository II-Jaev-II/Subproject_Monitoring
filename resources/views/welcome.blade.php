    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <div class=" selection:bg-[#FF2D20] selection:text-white">
            <nav x-data="{ open: false }"
                class="bg-lime-900 dark:bg-green-900 border-b border-lime-500 dark:border-green-700">
                <!-- Primary Navigation Menu -->
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex items-center space-x-4">
                            <img src="{{ asset('images/prdp_logo.png') }}" class="h-16" alt="PRDP Logo">
                            <label for="trackingSystem" class="text-slate-300 dark:text-slate-300">Subproject
                                Monitoring</label>
                        </div>
                        @if (Route::has('login'))
